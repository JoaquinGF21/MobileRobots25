...
def scan(maze, current):
    ...
    angle_to_dir = {180: "N", 0: "S", 90: "W", 270: "E"}
    dir_to_angle = {"N": 180, "S": 0, "W": 90, "E": 270}
    current_heading_angle = Movement.currentDirection
    heading = angle_to_dir.get(current_heading_angle)
    opposite = {"N": "S", "S": "N", "W": "E", "E": "W"}

    for dir, (dr, dc) in directions.items():
        if heading and dir == opposite[heading]:
            continue  # Skip scanning behind the robot
        r, c = row + dr, col + dc
